...
'''
this class is used to demonstrate the performance of bolasso (coordinate descent) using the sklearn built-in parallel archetecture
...
Modules:
    1. from scikit-learn, we call 'LassoCV' to compute bootstrap lasso;
