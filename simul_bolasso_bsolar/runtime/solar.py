...
'''
this class is used to compute "solar" and "solar-cd"
...
class solar:
    ...
    def fit(self):
        ...
        if (self.lasso == True):
            ...
            # 3a(1). call the class for CV-lars-lasso (called LassoLarsCV in Scikit-learn) and standardize X
...
if __name__ == '__main__':
    ...
    solar_coef, opt_c, test_error, Qc_list, Q_opt_c, la_list, la_vari_list, cd_list, cd_vari_list = trial2.fit_cd()
