...
'''
this class is used to demonstrate the performance of bolasso (lars) using the sklearn built-in parallel archetecture
...
class bolasso:
    ...
    def fit(self):
        ...
        for j in range(self.n_repeat_bolasso):
            ...
            trial_1 = LassoLarsCV(cv=10,n_jobs=-1, normalize=False)
