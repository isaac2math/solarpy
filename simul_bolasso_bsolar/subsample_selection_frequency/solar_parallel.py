...
please note that this file is identical to "solar.py" except the average solution path estimation, where in this file we use rewrite a sequential for-loop into a customized Joblib parallel scheme.
